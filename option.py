...
parser.add_argument('--data_test', type=str, default='MyImage',  # Set5 | Set14 | B100 | Urban100 | Manga109 | DIV2K_val
...
parser.add_argument('--model', default='LATTICENET',  # RCAN
                    help='model name')

parser.add_argument('--act', type=str, default='relu',
                    help='activation function')
parser.add_argument('--pre_train', type=str, default='../model/LatticeNet_x4.pt', #  RCAN_BIX4
...
# Log specifications
parser.add_argument('--save', type=str, default='myimage',
...
parser.add_argument('--testpath', type=str, default='.../DIV2K/val/validLR',
                    help='dataset directory for testing')

parser.add_argument('--testset', type=str, default='myimage',  #  Set5_bicLRx4 Set5 | Set14 | B100 | Urban100 | Manga109 | DIV2K_val
